...
<div class="modal fade" id="modalAlert" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  @if ($aberto)
	...
	<button class="btn btn-success m-2" id="close">Suplemento</button>
	<button class="btn btn-danger m-2" id="close">Sangria</button>
  @else
    ...
    $(function() {
        ...
        $('#close').click(function(){
 	    ...
 	    $('#btnSubmit').click(function(){
        	 $.post("{{route('caixa.fechar.view')}}", function( data ){
