...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/historico/editar', [HistoricoVendasController::class, 'editarTransacao'])->name('historico.editar.transacao'); 
    Route::post('/historico/excluir', [HistoricoVendasController::class, 'excluirTransacao'])->name('historico.excluir.transacao'); 
